    ...
    public class OffertesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OfferteId,TitelOfferte,TotaalBedrag,IsDeleted,KlantId,BedrijfId")] Offerte offerte)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string fileName = $"Inovice_{offerte.TitelOfferte}.pdf";
                ...
                string outFileImage = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "meublemalin.jpeg");
                ...
                Paragraph p14 = new Paragraph("Invoice: " + offerte.TitelOfferte + "\n\n", top);
                ...
                Paragraph p13 = new Paragraph("Customer: " + "\n", titleFont);
                ...
                Paragraph p12 = new Paragraph("Company: " + "\n", titleFont);
                ...
                Paragraph p11 = new Paragraph("TOTAL AMOUNT: " + offerte.TotaalBedrag + "€\n\n\n", titleFont);
                ...
                Paragraph p15 = new Paragraph("Dear " + klant.Name + " ,You have 10 days to make the payment!", bottom);
